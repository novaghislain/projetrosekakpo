      ...
      return (
        <div className="status-card glass-panel text-center success-final">
          ...
          <div style={{ marginTop: '2rem', padding: '1.5rem', backgroundColor: 'rgba(37, 211, 102, 0.1)', borderRadius: '12px', border: '1px solid rgba(37, 211, 102, 0.2)' }}>
            ...
            <a href={link} onClick={(e) => handleAccessClick(e, link, !programId.includes('ebook'))} target="_blank" rel="noreferrer" className="btn" style={{ backgroundColor: '#25D366', color: '#fff', border: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontWeight: 'bold', width: '100%', justifyContent: 'center' }}>
