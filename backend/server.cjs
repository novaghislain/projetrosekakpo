...
app.use((req, res, next) => {
  if (req.method === 'GET' && !req.path.startsWith('/api/admin') && !req.path.startsWith('/api/prices') && !req.path.startsWith('/api/contacts/track') && !req.path.startsWith('/api/payment') && !req.path.startsWith('/api/ping')) {
